    ...
    public partial class ImportManager : IImportManager
    {
        ...
        protected virtual async Task SaveCategoryAsync(bool isNew, Category category, Dictionary<string, ValueTask<Category>> allCategories, string curentCategoryBreadCrumb, bool setSeName, string seName)
        {
            ...
            if (isNew)
            {
                ...
                #region Extensions by QuanNH
                if (await storeMappingService.CurrentStore() > 0)
                {
                    await storeMappingService.InsertStoreMappingAsync(category, await storeMappingService.CurrentStore());
                }
                #endregion
            } else {
        ...
        public virtual async Task ImportProductsFromXlsxAsync(Stream stream)
        {
            ...
            {
                #region Extensions by QuanNH
                var allCategoryList = await _categoryService.GetAllCategoriesAsync(storeId: current_store_id, showHidden: true);
                #endregion
            ...
            #region Extensions by QuanNH
            var allManufacturers = await _manufacturerService.GetAllManufacturersAsync(storeId: current_store_id, showHidden: true);
            #endregion
            ...
            for (var iRow = 2; iRow < metadata.EndRow; iRow++)
            {
                ...
                #region Extensions by QuanNH
                var storeMappingService = Nop.Core.Infrastructure.EngineContext.Current.Resolve<Nop.Services.Stores.IStoreMappingService>();
                if (product != null && !await storeMappingService.AuthorizeAsync(product) && !await storeMappingService.IsAdminStore())
                {
                    return;
                }
                #endregion
        ...
        public virtual async Task ImportManufacturersFromXlsxAsync(Stream stream)
        {
            ...
            while (true)
            {
                ...
                var storeMappingService = Nop.Core.Infrastructure.EngineContext.Current.Resolve<Nop.Services.Stores.IStoreMappingService>();
                if (manufacturer != null && !await storeMappingService.AuthorizeAsync(manufacturer) && !await storeMappingService.IsAdminStore())
                {
                    return;
                }
                #endregion
        ...
        public virtual async Task ImportCategoriesFromXlsxAsync(Stream stream)
        {
            ...
            while (true)
            {
                ...
                #region Extensions by QuanNH
                var storeMappingService = Nop.Core.Infrastructure.EngineContext.Current.Resolve<Nop.Services.Stores.IStoreMappingService>();
                if (category != null && !await storeMappingService.AuthorizeAsync(category) && !await storeMappingService.IsAdminStore())
                {
                    return;
                }
                #endregion
